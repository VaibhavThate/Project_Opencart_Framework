...
# this file provides command line operation
...
def pytest_addoption(parser):
    ...
    parser.addoption("--headed", action="store_true", help = "Run in headed mode")
    parser.addoption("--base-url", default=None, help="Base URL for tests")
...
def page(request, browser_context):
    ...
    # Save and attach trace if tracing_option in ["on", "retain-on-failure"]
    if tracing_option in ["on", "retain-on-failure"]:
